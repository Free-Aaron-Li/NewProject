 ...
 * @version: JDK17
 * @Author: Aaron.Li
 * @Date: 2022-02-15 21:00:41
 * @LastEditTime: 2022-03-08 17:04:34
 */
package com.experience.experiment.class1;
/*
 * @author: Aaron.Li
...
public class CustomerTest {
    public static void main(String[] args) {
        ...
        System.out.println("Customer [" + test.getLastName() + "," + test.getFirstName() + "] has a account: id is "
                + test.getAccount().getId() +
                "," + "annualInterestRate is " + test.getAccount().getAnnualInterestRate() * 100 + "% ," + "balance is "
                + test.getAccount().getBalance());
    }
}
